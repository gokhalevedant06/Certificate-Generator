...
export default function Carousel() {
  ...
  return (
    <div
      class="card mb-4 mt-4 dark "
      style={{ backgroundColor: "#BDC7C9", width: 100 + "%" }}
    >
      <div class="d-flex justify-content-center pb-2 pt-3">
        <div className="slide active w-100 h-auto">
          <img height="300px" width="100%" src={"Firstc.png"} alt=""></img>
        </div>
        <div className="slide w-100 h-auto">
          <img height="300px" width="100%" src={"secondc.png"} alt=""></img>
        </div>
        <div className="slide w-100 h-auto">
          <img height="300px" width="100%" src={"thirds.png"} alt=""></img>
        </div>
        <div className="slide w-100 h-auto">
          <img height="300px" width="100%" src={"fourths.png"} alt=""></img>
        </div>
      </div>
      <div class="card-body pt-0">
        ...
        <p className="card-text text active">
          <em>Step 1 : </em>Upload the template. Preferred size is 1240 X 700.
        </p>
        <p className=" card-text text ">
          <em>Step 2 : </em> Follow steps sequentially from the side panel{" "}
        </p>
        <p className="card-text text ">
          <em>Step 3 : </em> Enter sample text and place it on the template
        </p>
        <p className="card-text text ">
          <em>Step 4 : </em> Lastly enter the sender's details and shoot the
          mails.
        </p>
      </div>
    </div>
